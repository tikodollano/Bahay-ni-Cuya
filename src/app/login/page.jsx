...
export default function LoginPage(){
    ...
    <div className="w-full h-[90%] flex">
        ...
        <div className="w-[50%] h-full flex flex-col justify-start items-center gap-10 py-5 mt-[5rem]">
            ...
            <div className="h-[850px] w-[450px] flex flex-col justify-start items-center gap-6">
                <p className="flex-grow-0 flex-shrink-0 text-3xl font-medium text-[#333333]">Login to your account</p>
                <div className="w-full flex flex-col justify-start items-start gap-4">
                    <label htmlFor="email" className="flex-grow-0 flex-shrink-0 text-base font-medium text-[#828282]">Email</label>
                    <input type="email" id="email" name="email" value={email} onChange={(e) => setemail(e.target.value)} className="flex-grow-0 flex-shrink-0 w-full h-10 px-4 border border-[#bdbdbd] rounded-lg focus:outline-none focus:border-[#333333]"/>
                    <label htmlFor="password" className="flex-grow-0 flex-shrink-0 text-base font-medium text-[#828282]">Password</label>
                    <input type="password" id="password" name="password" value={password} onChange={(e) => setPassword(e.target.value)} className="flex-grow-0 flex-shrink-0 w-full h-10 px-4 border border-[#bdbdbd] rounded-lg focus:outline-none focus:border-[#333333]"/>
