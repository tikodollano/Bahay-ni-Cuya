...
export default function LoginPage(){
    ...
    <div class="w-full h-[90px] absolute left-0 overflow-hidden bg-white">
        <div class="flex justify-end items-center absolute left-[1250px] top-[21px] gap-6">
            ...
            <div class="flex justify-end items-center flex-grow-0 flex-shrink-0 gap-2">
                ...
                <a href="/login">
                    <button class="flex justify-center items-center flex-grow-0 flex-shrink-0 relative overflow-hidden gap-2 px-5 py-3 rounded-[800px] border border-[#143a79]">
    ...
    <div class="w-full h-[90%] flex">
        <div class="w-[50%] h-80% flex justify-center items-center">
            <div class="w-[745px] h-[400px] relative">
                <svg
                    width="526"
                    height="526"
                    viewBox="0 0 526 526"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                    class="absolute left-[110px] top-[-1px]"
                    preserveAspectRatio="xMidYMid meet"
                >
                ...
                <svg
                    ...
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                    class="absolute left-[629px] top-[162px]"
                    preserveAspectRatio="xMidYMid meet"
                >
                ...
                <svg
                    ...
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                    class="absolute left-[54px] top-[414px]"
                    preserveAspectRatio="xMidYMid meet"
                >
                ...
                <svg
                    ...
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                    class="w-[29.2px] h-[53.98px]"
                    preserveAspectRatio="none"
                >
                    <img
                        src="./img/woman.png"
                        class="w-[382px] h-[530px] absolute left-[181px] top-[20px] object-cover"
                        style={{ boxShadow: '0px 24px 120px 0 rgba(51,51,51,0.24)' }}
                    />
                </svg>
            </div>
        </div>
        
        <div class="w-[50%] h-full flex flex-col justify-start items-center gap-10 py-5 mt-[5rem]">
            <div class="flex justify-start items-start flex-grow-0 flex-shrink-0 w-[450px] h-9 gap-6">
                <div class="flex justify-center items-center flex-grow relative overflow-hidden gap-2 px-5 py-3 rounded-[800px] bg-[#db4437]">
                    <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="flex-grow-0 flex-shrink-0 w-6 h-6 relative" preserveAspectRatio="xMidYMid meet">
                        <g clip-path="url(#clip0_2330_11061)">
                ...
                <div class="flex justify-center items-center flex-grow relative overflow-hidden gap-2 px-5 py-3 rounded-[800px] bg-[#4267b2]">
                    <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="flex-grow-0 flex-shrink-0 w-6 h-6 relative" preserveAspectRatio="xMidYMid meet">
                        <g clip-path="url(#clip0_2330_11056)">
            ...
            <div class="flex justify-center items-center flex-grow-0 flex-shrink-0 w-[667px] relative gap-6">
                <div class="flex-grow h-px relative">
                    <div class="w-[299.5px] h-px absolute left-[-1px] top-[-1px] bg-[#e0e0e0]"></div>
                </div>
                <p class="flex-grow-0 flex-shrink-0 text-base text-center text-[#828282]">OR</p>
                <div class="flex-grow h-px relative">
                    <div class="w-[299.5px] h-px absolute left-[-1px] top-[-1px] bg-[#e0e0e0]"></div>
                </div>
            </div>
            <div class="h-[850px] w-[450px] flex flex-col justify-start items-center gap-6">
                <p class="flex-grow-0 flex-shrink-0 text-3xl font-medium text-[#333333]">Login to your account</p>
                <div class="w-full flex flex-col justify-start items-start gap-4">
                    <label htmlFor="email" class="flex-grow-0 flex-shrink-0 text-base font-medium text-[#828282]">Email</label>
                    <input type="email" id="email" name="email" value={email} onChange={(e) => setemail(e.target.value)} class="flex-grow-0 flex-shrink-0 w-full h-10 px-4 border border-[#bdbdbd] rounded-lg focus:outline-none focus:border-[#333333]"/>
                    <label htmlFor="password" class="flex-grow-0 flex-shrink-0 text-base font-medium text-[#828282]">Password</label>
                    <input type="password" id="password" name="password" value={password} onChange={(e) => setPassword(e.target.value)} class="flex-grow-0 flex-shrink-0 w-full h-10 px-4 border border-[#bdbdbd] rounded-lg focus:outline-none focus:border-[#333333]"/>
                    <div class="flex justify-between items-center flex-grow-0 flex-shrink-0 w-full">
                        <div class="flex items-center gap-2">
                            <input type="checkbox" id="remember" name="remember" class="flex-grow-0 flex-shrink-0 w-4 h-4 rounded border-[#bdbdbd] appearance-none focus:outline-none cursor-pointer"/>
                            <label htmlFor="remember" class="flex-grow-0 flex-shrink-0 text-base text-[#333333]">Remember me</label>
                        </div>
                        <a href="#" class="flex-grow-0 flex-shrink-0 text-base text-[#2962ff]">Forgot password?</a>
                    </div>
                    <button onClick={handleSignIn} class="flex justify-center items-center flex-grow-0 flex-shrink-0 w-full h-12 bg-[#2962ff] rounded-lg text-white font-medium text-xl focus:outline-none">Login</button>
                </div>
            </div>
        </div>
    </div>
