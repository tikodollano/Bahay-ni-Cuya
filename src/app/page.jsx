...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between">
      ...
      <div className="w-full h-[90px] absolute left-0 overflow-hidden bg-[#e9f0fb]">
        <div className="flex justify-end items-center absolute left-[1250px] top-[21px] gap-6">
          ...
          <div className="flex justify-end items-center flex-grow-0 flex-shrink-0 gap-2">
            <a href="/register">
              <button className="flex justify-center items-center flex-grow-0 flex-shrink-0 relative overflow-hidden gap-2 px-5 py-3 rounded-[800px] bg-[#143a79]">
      ...
      <div className="w-full h-[800px] absolute left-0 top-[90px] bg-[#e9f0fb]">
        <div className="w-[708.75px] h-4/5 absolute left-[790.25px] top-0">
          <div className="w-[708.75px] h-[600px] absolute left-0 top-0">
            <div className="w-[800px] h-[600px] absolute left-[-151px] top-0">
              <svg
                width="496"
                height="495"
                viewBox="0 0 596 595"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                className="absolute left-[291px] top-[30px]"
                preserveAspectRatio="xMidYMid meet"
              >
              ...
              <svg
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                className="absolute left-[780px] top-[74px]"
                preserveAspectRatio="xMidYMid meet"
              >
              ...
              <svg
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                className="absolute left-[63px] top-[716px]"
                preserveAspectRatio="xMidYMid meet"
              >
                <circle cx="28.25" cy="28" r="28" fill="#143A79"></circle>
              </svg>
              <div className="absolute right-[393px] top-30">
                <svg
                width="149"
                height="120"
                viewBox="0 0 149 120"
              ...
              <div className="absolute bottom-[150px] right-[12px]">
                <svg
                  width="65"
                  height="120"
                  viewBox="0 0 65 120"
                ...
                <div className="w-[600px] h-[800px] absolute right-[-50px] top-[-350px]">
                  <img src="./img/Man.png" alt="man" 
                  className="w-full h-full absolute object-scale-down"
                  />
                </div>
                <div className="absolute h-96 w-96 top-[-220px] right-[850px]">
                  <p className="self-stretch flex-grow-0 flex-shrink-0 w-[427.5px] text-5xl font-medium text-left" > 
                    <span className="self-stretch flex-grow-0 flex-shrink-0 w-[427.5px] text-5xl font-medium text-left text-[#333]">Find</span>
                    <span className="self-stretch flex-grow-0 flex-shrink-0 w-[427.5px] text-5xl font-medium text-left text-[#143a79]">Custom Suits</span>
                    <span className="self-stretch flex-grow-0 flex-shrink-0 w-[427.5px] text-5xl font-medium text-left text-[#333]">Tailored For You</span>
                  </p>
                  <div className="flex-grow-0 flex-shrink-0 w-[200px] h-0.5 relative">
                    <div className="w-[200px] h-0.5 absolute left-[10px] top-[15px] bg-[#333]">
                    </div>
                  </div>
                  <p className="mt-8 self-stretch flex-grow-0 flex-shrink-0 w-[427.5px] text-base text-left text-[#333]">Our Shirt are crafted by cutting-edge technology using some of the world's finest and highest quality fabrics</p>
                  <button className="flex justify-center items-center flex-grow-0 flex-shrink-0 relative overflow-hidden gap-2 px-5 py-3 rounded-[800px] bg-[#ffd700] top-10">CUSTOMIZE NOW</button>
                </div>                                                                                                                                      
              </div>
            </div>
          </div>
    ...
    <section className="flex bg-white h-[650px] w-full p-4 justify-center">
      <div className="grid grid-cols-3 grid-rows-2 gap-4 h-full w-auto">
        <div className="product-card cursor bg-gray-200 h-300 w-[290px] border rounded-lg border-gray-400 relative">
          <div className="image-container h-4/5 w-full rounded-lg">
            <img src="img/cotton.jpg" alt="cotton" className="w-full h-full rounded-lg"/>
          </div>
        ...
        <div className="product-card cursor bg-gray-200 h-300 w-[290px] border rounded-lg border-gray-400 relative">
          <div className="image-container h-4/5 w-full rounded-lg">
            <img src="img/wool.jpg" alt="wool" className="w-full h-full rounded-lg"/>
          </div>
          <div className="details-container h-[20%] w-full bg-white rounded-lg p-2">
            <h4>PURE WOOL</h4>
            <h2>$4</h2>
        ...
        <div className="product-card cursor bg-gray-200 h-300 w-[290px] border rounded-lg border-gray-400 relative">
          <div className="image-container h-4/5 w-full rounded-lg">
            <img src="img/silk.jpg" alt="silk" className="w-full h-full rounded-lg"/>
          </div>
          <div className="details-container h-[20%] w-full bg-white rounded-lg p-2">
            <h4>PURE SILK</h4>
            <h2>$6</h2>
        ...
        <div className="product-card cursor bg-gray-200 h-300 w-[290px] border rounded-lg border-gray-400 relative">
          <div className="image-container h-4/5 w-full rounded-lg">
            <img src="img/satin.jpg" alt="satin" className="w-full h-full rounded-lg"/>
          </div>
          <div className="details-container h-[20%] w-full bg-white rounded-lg p-2">
            <h4>PURE SATIN</h4>
            <h2>$6</h2>
        ...
        <div className="product-card cursor bg-gray-200 h-300 w-[290px] border rounded-lg border-gray-400 relative">
          <div className="image-container h-4/5 w-full rounded-lg">
            <img src="img/linen.jpg" alt="linen" className="w-full h-full rounded-lg"/>
          </div>
          <div className="details-container h-[20%] w-full bg-white rounded-lg p-2">
            <h4>PURE LINEN</h4>
            <h2>$6</h2>
        ...
        <div className="product-card cursor bg-gray-200 h-300 w-[290px] border rounded-lg border-gray-400 relative">
          <div className="image-container h-4/5 w-full rounded-lg">
              <img src="img/polyester.jpg" alt="polyester" className="w-full h-full rounded-lg"/>
          </div>
          <div className="details-container h-[20%] w-full bg-white rounded-lg p-2">
      ...
      <div className="bg-blue-100 h-full w-[380px] ml-4 rounded-lg flex flex-col justify-center items-center p-10">
        <p className="self-stretch flex-grow-0 flex-shrink-0 w-[300px] text-5xl font-medium">
          <span className="w-[427.5px] text-5xl font-medium text-left text-[#333]">Explore</span>
          <span className="w-[427.5px] text-5xl font-medium text-left text-[#333]">Fabrics</span>
        </p>
        <div className="border-b-2 h-2 w-[290px] mt-4 mb-4 border-black"></div>
        <p>
        ...
        <button className="flex justify-center items-center flex-grow-0 flex-shrink-0 relative overflow-hidden gap-2 px-5 py-3 rounded-[800px] bg-[#ffd700] top-10">BROWSE ALL  </button>
      </div>          
    </section>
    <div className="flex flex-col justify-center items-center w-full h-[850px] gap-20 px-[375px]">
      <div
        className="flex flex-col justify-start items-center self-stretch flex-grow-0 flex-shrink-0 gap-10"
      >
        <div
          className="flex flex-col justify-start items-center self-stretch flex-grow-0 flex-shrink-0 gap-6"
        >
          <div
            className="flex flex-col justify-start items-center self-stretch flex-grow-0 flex-shrink-0 gap-6"
          >
            <div
              className="flex flex-col justify-center items-center self-stretch flex-grow-0 flex-shrink-0 relative gap-6"
            >
              <p
                className="self-stretch flex-grow-0 flex-shrink-0 w-[690px] text-5xl font-medium text-center text-black"
              >
                Why Choose Us
              </p>
              <div className="flex-grow-0 flex-shrink-0 w-[200px] h-0.5 relative">
                <div className="w-[200px] h-0.5 absolute left-[-1px] top-[-1px] bg-black"></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 gap-[30px]">
        <div className="flex justify-center items-center flex-grow-0 flex-shrink-0 w-[1170px] gap-[30px]">
          <div
            className="flex flex-col justify-center items-start flex-grow relative overflow-hidden gap-6 p-10 rounded-3xl bg-white"
            style={{
          ...
          >
            <svg
              ...
              preserveAspectRatio="xMidYMid meet"
            >
              <g clipPath="url(#clip0_2323_11086)">
                <path
            ...
            >
              <p
                className="self-stretch flex-grow-0 flex-shrink-0 w-[290px] text-[28px] font-medium text-left text-black"
              >
                Trusted
              </p>
              <p
                className="self-stretch flex-grow-0 flex-shrink-0 w-[290px] text-base text-left text-[#4f4f4f]"
              >
          ...
          >
            <svg
              ...
              preserveAspectRatio="xMidYMid meet"
            >
              <g clipPath="url(#clip0_2323_11095)">
                <path
          ...
          >
            <svg
              ...
              preserveAspectRatio="xMidYMid meet"
            >
              <g clipPath="url(#clip0_2323_11104)">
                <path
        ...
        <div className="flex justify-center items-center flex-grow-0 flex-shrink-0 w-[1170px] gap-[30px]">
          ...
          >
            <svg
              ...
              preserveAspectRatio="xMidYMid meet"
            >
              <g clipPath="url(#clip0_2323_11113)">
                <path
          ...
          >
            <svg
              ...
              preserveAspectRatio="xMidYMid meet"
            >
              <g clipPath="url(#clip0_2323_11122)">
                <path
          ...
          >
            <svg
              ...
              preserveAspectRatio="none"
            >
              <g clipPath="url(#clip0_2323_11131)">
                <path
